...
module.exports={
  sendEmailService(req,res) {
    ...
    sendEmailVerification(req.body.email, req.body.receiver, req.body.subject, req.body.content)
    res.send(req.body)
  }
}

const sendEmailVerification = (email, receiver, subject, content) => {
